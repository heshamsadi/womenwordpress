		...
		while ( $query->have_posts() ) { $query->the_post();
			if ($args['slider'] && !empty($args['slider_pagination_thumbs'])) {
				...
				$pagination_bullets .= '<span class="slider-pagination-button swiper-pagination-button"'
									...
									. '>'
                                        .'<span class="sc_testimonials_item_author_data">
                                            <span class="sc_testimonials_item_author_title">'. esc_html($title).'</span>
                                            <span class="sc_testimonials_item_author_subtitle">'. esc_html($meta["subtitle"]).' </span>
                                        </span>'
                                    .'</span>';
			}
