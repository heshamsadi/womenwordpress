...
Please install and activate it before starting to use the theme Rosalinda.
...
Theme documentation is available on http://rosalinda.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Rosalinda is Fontello.
