...
if ( ! function_exists( 'rosalinda_trx_addons_add_theme_vars' ) ) {
	add_filter( 'rosalinda_filter_add_theme_vars', 'rosalinda_trx_addons_add_theme_vars', 10, 2 );
	function rosalinda_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'rosalinda_trx_addons_get_css' ) ) {
	add_filter( 'rosalinda_filter_get_css', 'rosalinda_trx_addons_get_css', 10, 2 );
	function rosalinda_trx_addons_get_css( $css, $args ) {
...
.format-audio .post_featured .post_audio_title, .sc_services_item.with_pictogram .sc_services_item_subtitle, table:not(#wp-calendar) th {
	{$fonts['p_font-family']}
}
...
.breadcrumbs, 
.dishes_timing_number, 
.dishes_item_number,
nav.sc_item_pagination .nav-links, .post_avtor {
	{$fonts['button_font-family']}
}
.trx_addons_dropcap,
blockquote > cite, 
...
.sc_title.sc_title_coaching .sc_item_subtitle, .sc_services_item_price i,
.sc_dishes.sc_dishes_float .sc_dishes_item .sc_dishes_item_price,
.sc_dishes.sc_dishes_float .sc_footer_dishes-meta .dishes_timing_number,
.sc_dishes.sc_dishes_float .sc_footer_dishes-meta .dishes_item_number{
...
.sc_recent_news .post_item.post_layout_news-announce .post_featured .post_info .post_title a:hover{
    color:{$colors['text_link']};
}
.post_layout_news-announce.post_size_medium, .post_layout_news-announce.post_size_medium + .post_layout_news-announce.post_size_medium{
...
.sc_footer_dishes-meta .dishes_timing_icon > span,
.sc_footer_dishes-meta .dishes_ingridients_icon > span{
    color: {$colors['extra_dark']}; 
    background-color: {$colors['text_link']}; 
}
...
.sc_services_item.with_pictogram .sc_services_item_title a, .sc_title.sc_title_icon .sc_item_title{
    color: {$colors['input_dark']};
}
.sc_services_item.with_pictogram .sc_services_item_title a:hover{
    color: {$colors['text_link']};
}
...
.sc_services_item_footer .sc_services_item_price i{
    color: {$colors['text_hover']};
}
.sc_services_item_info .sc_services_item_link a{
    color: {$colors['extra_dark']};
	background-color: {$colors['text_link']};
}
.sc_services_item_info .sc_services_item_link a:hover{
    color: {$colors['extra_dark']};
	background-color: {$colors['text_hover']};
}
...
.sc_services.sc_services_extra .sc_services_item_title a, .sc_services.sc_services_extra .sc_services_item_excerpt{
    color:{$colors['extra_dark']};
}
.sc_services.sc_services_extra .sc_services_item_title a:hover{
    color:{$colors['text_link']};
}
...
.sc_title.sc_title_icon .sc_item_title:before, .sc_title.sc_title_coaching .sc_item_title:before{
    color: {$colors['text_hover']};
}
.sc_title.sc_title_extra .sc_item_subtitle, .sc_title.sc_title_extra .sc_item_descr{
    color: {$colors['text_dark']};
}

.sc_title.sc_title_coaching .sc_item_descr, .sc_title.sc_title_coaching .sc_item_title,
...
.extra-color.sc_title.sc_title_default .sc_item_subtitle {
    color: {$colors['alter_hover3']};
}
.extra-color.sc_title.sc_title_default .sc_item_descr {
    color: {$colors['extra_dark']};
}
.extra-color.sc_title.sc_title_default .sc_item_button a{
    color: {$colors['text_link']};
    background-color: {$colors['extra_dark']};	
    border-color:{$colors['extra_dark']};	
}
.extra-color.sc_title.sc_title_default .sc_item_button a:hover {
    color: {$colors['extra_dark']};
    background-color: {$colors['text_hover']};	
    border-color:{$colors['text_hover']};	
}
...
.scheme_self.wpb_column .check_form a{
    color: {$colors['extra_dark']};
}
.scheme_self.wpb_column .check_form a:hover{
    color: {$colors['text_dark']};
}

.scheme_self.wpb_column  div form.mc4wp-form .mc4wp-form-fields input[type="submit"]{
    background-color: {$colors['extra_dark']};
	border-color: {$colors['extra_dark']};
	color: {$colors['text_link']};
}
.scheme_self.wpb_column  div form.mc4wp-form .mc4wp-form-fields input[type="submit"]:hover{
    background-color: {$colors['text_hover']};
	border-color: {$colors['text_hover']};
	color: {$colors['extra_dark']};
}
...
.esgbox-share__button:hover, .esgbox-close-small:hover:after{
    color: {$colors['text_link']};
}
