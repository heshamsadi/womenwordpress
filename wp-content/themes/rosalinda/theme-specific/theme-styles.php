...
if ( ! function_exists( 'rosalinda_customizer_get_css' ) ) {

	function rosalinda_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = rosalinda_customizer_add_theme_fonts( $fonts );
...
CSS;
			$rez          = apply_filters( 'rosalinda_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			// Make theme-specific fonts rules
			$vars = rosalinda_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'rosalinda_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		//--------------------------------------
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( rosalinda_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					// Prepare colors
					if ( empty( $scheme ) ) {
						$colors = rosalinda_get_scheme_colors( $s );
					}
...
figure:not(.wp-block-gallery):not(.wp-block-video):not(.wp-block-embed) figcaption,
.wp-caption .wp-caption-text,
.wp-caption .wp-caption-dd,
.wp-caption-overlay .wp-caption .wp-caption-text,
.wp-caption-overlay .wp-caption .wp-caption-dd {
	color: {$colors['extra_dark']};
	background-color: {$colors['text_link2_07']};
}
...
.widget_search form:not(.wp-block-search__button-outside):hover:after,
...
.scheme_self.wpb_column input[type="text"],
.scheme_self.wpb_column input[type="email"],
.scheme_self.wpb_column textarea{
...
input[type="email"]:hover, textarea:hover, input[type="text"]:hover{
	color: {$colors['input_dark']};
	border-color: {$colors['text_link']};
	background-color: {$colors['input_bg_hover']};
}

div form.mc4wp-form .mc4wp-form-fields input[type="email"]:focus,
div form.mc4wp-form .mc4wp-form-fields input[type="email"].filled{
...
.wp-block-archives .select_container:before,
.wp-block-search.wp-block-search__button-inside .wp-block-search__inside-wrapper {
	color: {$colors['input_text']};
	background-color: {$colors['inverse_link']} !important;
}

.wp-block-archives .select_container select:focus,
.wp-block-archives .select_container:hover:before,
.wp-block-archives .select_container:focus:before,
...
.sidebar .select_container select, .sidebar .select_container select:focus {
...
.blog_style_excerpt .post_item.sticky .post_title a:hover{
     color:{$colors['extra_dark']};
}

.blog_style_excerpt .post_item.sticky{
    background-color: {$colors['text_link']}!important;
}
.blog_style_excerpt .post_item.sticky .post_content_inner,
.blog_style_excerpt .post_item.sticky .post_counters_item{
   color: {$colors['extra_dark']};
}
.blog_style_excerpt .post_item.sticky .post_counters_item:hover{
   color: {$colors['text_dark']};
}

.blog_style_excerpt .post_item.sticky .post_counters_item:before{
    background-color: {$colors['extra_dark']};
    color:{$colors['text_link']};
}

.blog_style_excerpt .post_item.sticky .post_avtor, .blog_style_excerpt .post_item.sticky .post_avtor .post_author{
    color: {$colors['text_dark']};
}
.blog_style_excerpt .post_item.sticky .post_avtor .post_author:hover{
    color: {$colors['extra_dark']};
}
...
.rosalinda_tabs .rosalinda_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.rosalinda_tabs .rosalinda_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .rosalinda_tabs .rosalinda_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .rosalinda_tabs .rosalinda_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .rosalinda_tabs .rosalinda_tabs_titles li.ui-state-active a {
	color: {$colors['alter_bg_color']};
	background-color: {$colors['alter_dark']};
}

/* Post layouts */
.blog_style_excerpt:not(.home) .post_item, .single-post .post_item_single {
	color: {$colors['text']};
	background-color: {$colors['alter_bg_color']};
}
.navigation.post-navigation .nav-links .nav-previous a .nav-arrow:after, .navigation.post-navigation .nav-links .nav-next a .nav-arrow:after{
    color: {$colors['extra_dark']};
	background-color: {$colors['text_link']};
}
.post_meta,
...
.sticky  .post_meta_item.post_categories a:hover, .sticky .post_meta_item a:hover {
	color: {$colors['text_dark']};
}
.sticky .post_meta_item a, .sticky .post_meta_item{
    color: {$colors['extra_dark']};
}
...
.comments_list_wrap .comment_author, .comments_list_wrap .comment_date{
    color: {$colors['text_light']};
}
...
.comments_wrap .comments_field textarea, .comments_wrap .comments_field input{
   background-color: {$colors['bg_color']};  
}
...
.sidebar .widget_aboutme .socials_wrap .social_item .social_icon{
     background-color: {$colors['bg_color']}; 
     color: {$colors['text_link']};  
}
...
footer .wp-block-calendar .wp-calendar-nav-prev a:before,
footer .wp-block-calendar .wp-calendar-nav-next a:before,
footer .widget_calendar .wp-calendar-nav-prev a:before,
footer .widget_calendar .wp-calendar-nav-next a:before {
	background-color: {$colors['bg_color']};
}
...
CSS;
					...
					$rez            = apply_filters(
						'rosalinda_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'rosalinda_filter_prepare_css', $css_str, $remove_spaces );
	}
}
