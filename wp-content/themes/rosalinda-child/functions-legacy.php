...
array(
    'name' => 'Cooking',
    'slug' => 'cooking',
    'description' => 'Fast, high-probability cooking hubs designed for SEO scale and AdSense revenue.',
    'children' => array(
        array(
            'name' => 'Quick & Few-Ingredient',
            'slug' => 'quick-few-ingredient',
            'children' => array(
                array('name' => '15-Minute Meals',        'slug' => '15-minute-meals'),
                array('name' => '30-Minute Dinners',       'slug' => '30-minute-dinners'),
                array('name' => '5-Ingredient Dinners',    'slug' => '5-ingredient-dinners'),
                array('name' => 'No-Cook Lunches',         'slug' => 'no-cook-lunches'),
                array('name' => 'Microwave Mugs',          'slug' => 'microwave-mugs'),
            ),
        ),
        array(
            'name' => 'Healthy & Metabolic',
            'slug' => 'healthy-metabolic',
            'children' => array(
                array('name' => 'High-Protein Breakfasts',     'slug' => 'high-protein-breakfasts'),
                array('name' => '20-30g Protein Dinners',      'slug' => '20-30g-protein-dinners'),
                array('name' => 'Anti-Inflammatory Bowls & Soups','slug' => 'anti-inflammatory-bowls-soups'),
                array('name' => 'Omega-3 Seafood',             'slug' => 'omega-3-seafood'),
                array('name' => 'High-Fiber Sides',            'slug' => 'high-fiber-sides'),
            ),
        ),
        array(
            ...
            'children' => array(
                array('name' => 'Air Fryer',         'slug' => 'air-fryer'),
                array('name' => 'Sheet-Pan',         'slug' => 'sheet-pan'),
                array('name' => 'Instant Pot',       'slug' => 'instant-pot'),
                array('name' => 'Slow Cooker',       'slug' => 'slow-cooker'),
                array('name' => 'One-Pot Skillet',   'slug' => 'one-pot-skillet'),
            ),
        ),
        array(
            'name' => 'Budget & Family',
            'slug' => 'budget-family',
            'children' => array(
                array('name' => 'Under $10 Dinners',      'slug' => 'under-10-dinners'),
                array('name' => 'Pantry-Only Meals',      'slug' => 'pantry-only-meals'),
                array('name' => 'Family Dinners (Feeds 4)','slug' => 'family-dinners-feeds-4'),
                array('name' => 'Student / Single-Serve', 'slug' => 'student-single-serve'),
                array('name' => 'Freezer-Friendly',       'slug' => 'freezer-friendly'),
            ),
        ),
        array(
            'name' => 'Special Diets',
            'slug' => 'special-diets',
            'children' => array(
                array('name' => 'Gluten-Free',                'slug' => 'gluten-free'),
                array('name' => 'Dairy-Free',                 'slug' => 'dairy-free'),
                array('name' => 'Vegan & Vegetarian Mains',   'slug' => 'vegan-vegetarian-mains'),
                array('name' => 'Low-Carb / Keto',            'slug' => 'low-carb-keto'),
                array('name' => 'Diabetic-Friendly',          'slug' => 'diabetic-friendly'),
            ),
        ),
        array(
            ...
            'children' => array(
                array('name' => 'Mini Desserts',          'slug' => 'mini-desserts'),
                array('name' => 'No-Bake Treats',         'slug' => 'no-bake-treats'),
                array('name' => 'Protein Desserts',       'slug' => 'protein-desserts'),
                array('name' => 'Cookies & Bars',         'slug' => 'cookies-bars'),
                array('name' => 'Muffins & Quick Breads', 'slug' => 'muffins-quick-breads'),
            ),
        ),
    ),
),
        ...
        array(
            'name' => 'Cooking',
            'slug' => 'cooking',
            'description' => 'Quick recipes, healthy meals, and cooking methods for every lifestyle and dietary need.',
            'children' => array(
                array(
                    'name' => 'Quick & Few-Ingredient',
                    'slug' => 'quick-few-ingredient',
                ...
                array(
                    ...
                    'children' => array(
                        array('name' => 'Air Fryer', 'slug' => 'air-fryer'),
                        array('name' => 'Sheet-Pan', 'slug' => 'sheet-pan'),
                        array('name' => 'Instant Pot / Slow Cooker', 'slug' => 'instant-pot-slow-cooker'),
                    ),
                ),
                array(
                    'name' => 'Budget & Family',
