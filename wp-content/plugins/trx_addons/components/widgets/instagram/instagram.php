...
class trx_addons_widget_instagram extends TRX_Addons_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'trx_addons_widget_instagram', esc_html__('ThemeREX Custom Feeds for Instagram', 'trx_addons'), $widget_ops );
	}
...
if (!function_exists('trx_addons_widget_instagram_reg_shortcodes_vc_params')) {
	function trx_addons_widget_instagram_reg_shortcodes_vc_params() {
		return apply_filters('trx_addons_sc_map', array(
				...
				"name" => esc_html__("Custom Feeds for Instagram", 'trx_addons'),
			...
			register_block_type(
				'trx-addons/instagram', array(
					'attributes'      => array(
						'title'       => array(
							'type'    => 'string',
							'default' => esc_html__( 'Custom Feeds for Instagram', 'trx_addons' ),
						),
						'count'       => array(
							'type'    => 'number',
							'default' => 8,
