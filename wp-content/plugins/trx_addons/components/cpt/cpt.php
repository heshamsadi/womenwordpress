	...
	function trx_addons_cpt_dishes_get_list_options($add_parameters=array()) {
		return apply_filters('trx_addons_cpt_list_options', array(
            ...
            'expand_content_dishes' => array(
                'title' => esc_html__( 'Expand content on the single dishes', 'trx_addons' ),
                'desc' => wp_kses_data( __( 'Expand the content width if the sidebar is hidden', 'trx_addons' ) ),
                'refresh' => false,
                'std' => 0,
                'type' => 'checkbox',
                'override' => array(
                    'mode' => 'page,cpt_team,cpt_services,cpt_dishes,cpt_competitions,cpt_rounds,cpt_matches,cpt_cars,cpt_properties,cpt_courses,cpt_portfolio',
                    'section' => esc_html__( 'Content', 'trx_addons' ),
                ),
            )
		), 'dishes');
	}
