...
if (!function_exists('trx_addons_cpt_dishes_init')) {
	...
	function trx_addons_cpt_dishes_init() {
		...
		trx_addons_meta_box_register(TRX_ADDONS_CPT_DISHES_PT, array(
            ...
            "number" => array(
                "title" => esc_html__("Ingredients number",  'trx_addons'),
                "desc" => wp_kses_data( __("Ingredients of this dish. Each element on the new row", 'trx_addons') ),
                "std" => "",
                "type" => "textarea"
            ),
            "icon" => array(
                ...
                "desc" => wp_kses_data( __("Ingredients number icon.", 'trx_addons') ),
                "std" => "",
                "options" => array(),
            ...
            "time" => array(
                ...
                "desc" => wp_kses_data( __("Cocking Time.", 'trx_addons') ),
                "std" => "",
                "type" => "textarea"
            ),
            "time-icon" => array(
                "title" => esc_html__("Time icon",  'trx_addons'),
                "desc" => wp_kses_data( __("Cooking time icon.", 'trx_addons') ),
                "std" => "",
                "options" => array(),
                "style" => trx_addons_get_setting('icons_type'),
                "type" => "icons"
